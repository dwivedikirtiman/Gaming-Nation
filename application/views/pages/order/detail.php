					...
					<table class="table table-bordered text-center">
						...
						<tbody>
							<?php foreach($order_detail as $od) : ?>
								<tr>
									...
									<td><h5>INR.<?= number_format($od['price'], 2,'.', ',') ?></h5></td>
								</tr>
							<?php endforeach ?>
						</tbody>
						<tfoot class="bg-success text-light">
							<tr>
								...
								<td><h5><strong>INR. <?= number_format(array_sum(array_column($order_detail, 'subtotal')), 2,'.', ',') ?></strong></h5></td>
							</tr>
						</tfoot>
					</table>
				</div>
			...
			<div class="col-8">
				<div class="card">
					...
					<div class="card-body">
						...
						<p>Amount Transferred: <strong class="text-info">INR. <?= number_format($order_confirm['nominal'], 2,'.', ',') ?></strong></p>
